...
var warbandResources = {
    ...
    adventurePoints: 0, // 0Starting adventure points
    goldMarks: 3 // 3 Starting gold marks
};

var stash = {
    equipmentStash: ["2 Silvertree Leaf"], // Add on creation: 2 Silvertree Leaf
    backpack: [""]
    // Add on creationw:
    // Heroes:  
    // 2 Quality Weapons, 2 Basic Weapons. Max 2 Ranged.
    // 2 partial Armor, 2 Light Armor, 1 Helmet, 1 Shield.
    // OR: 1 Full Armor, 1 Partial Armor, 1 Light Armor
    // Followers:
    // Standard Weapon or Staff. Self-bow and Light weapon if not maxed out on ranged.
    // 1 Light Armor
};
...
var warband = [
    {
        ...
        name: "Avatar Name", // Name of the character
    ...
    },
    {
        ...
        name: "Hero 1", // Name of the character
    ...
    },
    {
        ...
        name: "Hero 2", // Name of the character
        type: "Hero", // Avatar, Hero, Follower, Dead/Retired
        notes: "", // short desciption or notes
        origin: "", // Human, Fey-blood, Duskling, Preen, Halfling, Feral
        background: "", // Frontier (Halfling, Human), Mystic (One), Noble (Human), Outsider (Fey-blood, Duskling), Townsfolk (Human, Preen, Feral), Zealot (Human)
    ...
    },
    {
        ...
        name: "Hero 3", // Name of the character
        type: "Hero", // Avatar, Hero, Follower, Dead/Retired
        notes: "", // short desciption or notes
        origin: "", // Human, Fey-blood, Duskling, Preen, Halfling, Feral
        background: "", // Frontier (Halfling, Human), Mystic (One), Noble (Human), Outsider (Fey-blood, Duskling), Townsfolk (Human, Preen, Feral), Zealot (Human)
    ...
    },
    {
        ...
        name: "Follower 1", // Name of the character
